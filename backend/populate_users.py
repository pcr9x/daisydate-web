...
user1 = UserInfo(
    ...
    photos=["assets/populateUserImages/petch.jpg"],
    gender="Male",
    id=str(uuid.uuid4()),
    detail={
...
user2 = UserInfo(
    ...
    photos=["assets/populateUserImages/capt.jpg"],
    gender="Other",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I love Ferrari.",
...
user3 = UserInfo(
    ...
    date_of_birth=datetime.strptime("2004-07-06", "%Y-%m-%d"),
    age=(datetime.now() - datetime.strptime("2004-07-06", "%Y-%m-%d")).days // 365,
    photos=["assets/populateUserImages/wit.jpg"],
...
user4 = UserInfo(
    ...
    photos=["assets/populateUserImages/minji.jpeg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
...
user5 = UserInfo(
    ...
    photos=["assets/populateUserImages/yunjin.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
...
user6 = UserInfo(
    ...
    photos=["assets/populateUserImages/iu.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I'm a singer.",
...
user7 = UserInfo(
    ...
    photos=["assets/populateUserImages/chaewon.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I'm a member of LE SSERAFIM.",
...
user8 = UserInfo(
    ...
    photos=["assets/populateUserImages/wonyoung.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
...
user9 = UserInfo(
    ...
    photos=["assets/populateUserImages/sakura.jpeg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I'm a member of LE SSERAFIM.",
...
user10 = UserInfo(
    ...
    photos=["assets/populateUserImages/hanni.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I'm a member of NewJeans.",
...
user11 = UserInfo(
    ...
    photos=["assets/populateUserImages/jennie.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
...
user12 = UserInfo(
    ...
    photos=["assets/populateUserImages/yujin.jpg"],
    gender="Female",
    id=str(uuid.uuid4()),
    detail={
        "bio": "I'm a member of IVE.",
